    ...
    <div class="card mb-4">
      <div class="card-content">
        ...
        <p>
          ...
          whether 100% is for one dumbbells or two (it's for one), which exercises use two dumbbells, which use one, and
          how many dumbbells and at what weights do I actually need.
        </p>
        <p>
